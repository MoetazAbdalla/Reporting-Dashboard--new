    ...
    def update_dashboard(selected_sheet):
        ...
        if 'Region' in df.columns and 'Status' in df.columns:
            ...
            combined_region_chart = px.bar(
                ...
                color='variable',
                barmode='group',
                title="Top 5 Regions Total Applications Vs Total Paid",
        ...
        top_applied_english_programs_pie_chart = generate_pie_chart('Program', 'applied',
                                                                    "Top 10 Applied English Programs")
        top_applied_turkish_programs_pie_chart = generate_pie_chart('Program', 'applied',
                                                                    "Top 10 Applied Turkish Programs")
